  ...
  return (
    <div className="container mx-auto px-4 py-4 sm:py-8 font-sans">
      ...
      <div className="mb-4 sm:mb-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Your Shopping Cart</h1>
        <p className="mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">Review and manage your items before checkout</p>
      </div>
        ...
        <>
              ...
              <table className="w-full min-w-[600px] border-collapse">
                <thead>
                  <tr className="border-b border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                    <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Items</th>
                    <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Title</th>
                    <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Price</th>
                    <th className="text-center py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Quantity</th>
                    <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Total</th>
                    <th className="text-center py-3 px-4 text-gray-700 dark:text-gray-300 font-semibold text-sm">Remove</th>
                  </tr>
                </thead>
                <tbody>
                  {cartItems.map((item) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm sm:text-base text-gray-600 dark:text-gray-300">Delivery Fee</span>
                  ...
                  <div className="flex justify-between pt-3 border-t border-gray-100 dark:border-gray-700 mt-3">
                    <span className="text-base sm:text-lg font-semibold dark:text-white">Total</span>
            ...
            <div className="lg:col-span-1 space-y-4">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6">
                <h3 className="text-base font-semibold mb-3 text-gray-900 dark:text-white">Promo Code</h3>
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-3">Enter your promo code for discounts</p>
                <div className="flex">
                  <input
                    type="text"
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 sm:p-6">
                <h4 className="font-medium text-blue-800 dark:text-blue-300 mb-1 sm:mb-2 text-sm sm:text-base">Free Delivery</h4>
                <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-400">Enjoy free delivery on orders over ₹499</p>
              </div>
            </div>
          </div>
