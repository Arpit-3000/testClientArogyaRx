...
const Order = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6 bg-white rounded shadow-md">
      ...
      <div className="flex justify-between border border-gray-200 rounded p-4">
        <div>
          <p className="font-semibold text-gray-700">Order Number</p>
          <p className="mt-1 text-gray-900 font-mono text-lg">70638165</p>
        </div>
        <div className="text-right">
          <p className="font-semibold text-gray-700">Order Placed</p>
          <p className="mt-1 text-gray-900 font-mono text-lg">23 May 2025</p>
        </div>
      </div>
      ...
      <div className="border border-gray-200 rounded p-4 space-y-3">
        ...
        <div className="flex space-x-4">
          ...
          <div className="text-gray-700 text-sm space-y-1">
            <p className="font-semibold text-gray-900">IBUACT</p>
      ...
      <div className="border border-gray-200 rounded p-4 space-y-3">
        ...
        <p className="text-gray-600 text-sm">On 24 May 2025, 05:01 pm</p>
        <div className="w-full h-2 bg-gray-300 rounded-full overflow-hidden mt-2 relative">
        ...
        <p className="text-gray-500 text-xs text-right mt-1">
          Arriving by <strong>30 May 2025</strong>
        </p>

        <div className="flex justify-between mt-4 space-x-4">
          <button
            disabled
            className="flex-1 cursor-not-allowed border border-gray-300 text-gray-400 rounded py-2 text-center"
          >
            Cancel
          </button>
          <button className="flex-1 border border-blue-500 text-blue-600 rounded py-2 text-center hover:bg-blue-50">
            Track
          </button>
        </div>
      </div>
      ...
      <div className="border border-gray-200 rounded p-4 space-y-2">
        ...
        <button className="bg-orange-100 text-orange-600 text-xs font-semibold px-3 py-1 rounded float-right">
          Home
        </button>
      </div>
      ...
      <div className="border border-gray-200 rounded p-4 flex justify-between items-center">
        <div>
          ...
          <p className="text-lg font-semibold text-gray-900">₹93.00</p>
          <button className="text-blue-600 text-sm mt-1 hover:underline">View Breakup</button>
        </div>
        <div className="text-right">
          <p className="text-sm text-gray-700">Paid by</p>
          <p className="text-md font-medium text-gray-900">UPI</p>
        </div>
      </div>

      {/* Help Section */}
      <div className="border border-gray-200 rounded p-4 text-center text-blue-600 font-medium hover:underline cursor-pointer">
        Need Help?
      </div>
      ...
      <div className="border border-gray-200 rounded p-4 space-y-3">
        ...
        <div className="mt-4">
          <p className="font-semibold text-gray-600">
            Arriving by <span className="text-black">Fri, 30 May, 2025</span>
          </p>
          <ul className="mt-2 space-y-1">
            {[
              ...
              <li key={idx} className="flex items-center space-x-2 text-green-700 text-sm">
