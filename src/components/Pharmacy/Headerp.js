            ...
            >
                ...
                >
                    <h2 className="text-xl sm:text-2xl font-semibold text-green-800 dark:text-green-300 mb-2">
                        {t('headerp.callToAction')}
                    </h2>
                    <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                        {t('headerp.description.line1')} <br className="hidden sm:block" />
                        <span className="text-green-800 dark:text-green-400 font-medium">{t('app.title')}</span> {t('headerp.description.line2')}
                    </p>
                </motion.div>
